...
- 编辑脚本：
  ...
  **初始选项：**
  ...
  - 组合方式：提供两种组合方式-顺序和替换：顺序将起始脚本和参数顺序组合提交；替换则类似Jenkins的处理方式，如，当配置为"python3 %参数%"的时候，系统会将"%参数%"替换为"参数"组件内填写或选择的值，当参数填写为"Awesome.py"的时候，最终生成的命令将是"python3 Awesome.py"
